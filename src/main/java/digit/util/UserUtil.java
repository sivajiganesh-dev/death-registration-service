...
public class UserUtil {
    ...
    public UserDetailResponse userCall(Object userRequest, StringBuilder uri) {
        ...
        if (uri.toString().contains(userSearchEndpoint) || uri.toString()
            .contains(userUpdateEndpoint)) {
        ...
        try {
            ...
            UserDetailResponse userDetailResponse = mapper.convertValue(responseMap,
