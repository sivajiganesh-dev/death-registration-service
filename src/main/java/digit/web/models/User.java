...
/**
 * This is acting ID token of the authenticated user on the server. Any value provided by the
 * clients will be ignored and actual user based on authtoken will be used on the server.
 */
